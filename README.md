...
## Note
 This codebase accompanies the paper submission "LILAC: Learning a Leader for Cooperative Reinforcement Learning" , and is based on  [PyMARL](https://github.com/oxwhirl/pymarl) and [SMAC](https://github.com/oxwhirl/smac) codebases which are open-sourced.
